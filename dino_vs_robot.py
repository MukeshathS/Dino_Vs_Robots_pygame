...
currentDirectory = pathlib.Path("C:/Users/Mukeshnath S/Documents/Projects/Games_Python/PyGame/robotfree/png")
...
for i in sprite_imgs_enemy:
    req_images_enemy.append(i._parts[0] + '\\'.join(i._parts[1:]))
